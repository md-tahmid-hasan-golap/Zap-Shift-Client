    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 px-4">
      <div className="card w-full max-w-md glass shadow-2xl p-6 rounded-2xl border border-white/20 backdrop-blur-lg">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          ...
          {/* Submit Button */}
          <button className="btn w-full bg-gradient-to-r from-purple-600 to-pink-500 border-none text-white text-lg font-bold shadow-lg hover:scale-105 transition-transform duration-300">
            Register
          </button>
        </form>
